...
BASH_SUITE=(
  smoke provider provider-conformance ratelimit limitstate limitresume limitmonitor pause plan-review liveliness monitor teardown reapscope reapenv bystander noworkguard noworkguard-jsononly headless events container account-env
